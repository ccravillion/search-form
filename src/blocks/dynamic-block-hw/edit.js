	...
	return (
			<div {...useBlockProps()}>
				...
				<div className="flip-card-inner">
					...
					<div className="flip-card-back" style={{backgroundColor: attributes.backgroundColor}}>
						<h3 className="name" style={{color: attributes.headingColor}}>Red Forman</h3>
						<div className="technology" style={{color: attributes.textColor}}>Manager</div>
						<div className="technology" style={{color: attributes.textColor}}>Manager</div>
						<div className="link" style={{color: attributes.textColor}}>
